!function(t){"use strict"
    ...
    s.grid||(t.jQuery.fn.grid=function(t){var i
        ...
        for(t=parseFloat(t)||0,t=(""+Math.round(t*g)/g).split("."),o=t[0],h=(t[1]||""+l).slice(0,i),r=o.length,d=r%3,n=d?[o.slice(0,d)]:[],e=0,a=Math.floor(r/3);a>e;e+=1)n.push(o.slice(d+3*e,d+3*e+3))
        ...
        this.gridStyle=a.find(".grid-style").eq(0),this.gridHead=o.find(".grid-head").eq(0),this.gridBody=o.find(".grid-body").eq(0),this.gridOverlay=o.find(".grid-overlay").eq(0),this.gridHeadTable=this.gridHead.children(".grid-head-table").eq(0),this.gridLine=o.find(".grid-line").eq(0),this.gridScroll=o.find(".grid-scroll").eq(0),this.gridTfoot=a.children(".grid-tfoot").eq(0),this.gridEmpty=this.gridBody.children(".grid-empty").eq(0),this.loading=a.children(".grid-loading-bg").next().andSelf(),this.gridTableHide=s(".grid-table-hide",a).eq(0).append(i.addClass("grid-body-table")),t.wrap||i.addClass("grid-ellipsis"),t.headerWrap||this.gridHeadTable.addClass("grid-ellipsis")},__theadClickEventBind:function(){var t=this.options,i=this.bindName,e=this
        ...
        return"grid-page-next"===t?(h<(Math.ceil(this.totalSize/o.recordSize)||1)&&(o.pageNo=h+1,this._setPageNoList()),void 0):"grid-page-prev"===t?(h>1&&(o.pageNo=h-1,this._setPageNoList()),void 0):"grid-page-go"===t?(a=this.paginationGo.val().replace(/\s+/g,"")-0,isNaN(a)||a===h||(o.pageNo=a,this._setPageNoList()),void 0):(s=this.options.recordSizeList,r=this.pageNoList,i=(/grid\-page\-size\-(\d)/.exec(t)||[])[1],i&&o.recordSize!==s[i]?(o.recordSize=s[i],this._setPageNoList()):(e=(/grid\-page\-no\-(\d)/.exec(t)||[])[1],e&&h!==r[e]&&(o.pageNo=r[e],this._setPageNoList())),void 0)},_setPageNoList:function(){var t,i,e=this.query,s=e.recordSize,r=this.options.recordSizeList,a=this.paginationPageSize,o=Math.ceil(this.totalSize/s)||1,h=Math.min(e.pageNo,o),d=Math.max(h-2,1),n=Math.min(d+4,o),l=this.pageNoList=[],c=this.paginationPageNo,g=this.paginationPageEllipsis
        ...
        d.push("</div>",'<div class="grid-hidecol-button">','<a href="javascript:;" hidefocus="true" class="grid-hidecol-confirm">确定</a>','<a href="javascript:;" hidefocus="true" class="grid-hidecol-cancel">取消</a>',"</div>"),i.html(d.join("")),this.gridHidecolList=i.find(".grid-hidecol-list")[0],this.domA=this.gridHidecolList.getElementsByTagName("a"),this.bindEvent(t,i)},bindEvent:function(t,i){function e(){for(var t=l;o>t;t+=1)p[t]?s(g[t-l]).addClass("grid-hidecol-nochecked"):s(g[t-l]).removeClass("grid-hidecol-nochecked")}{var r,a,o=t.colSize,h=t.gridBox,d=null,n=!1,l=0,c=-1,g=this.domA
